...
typedef struct s_e_kinesis
{
	...
	int				*phs_states;	//	indique l'etat des philos en fonction de la struct enum
...
typedef struct s_p_kinesis
{
	...
	int				*ph_state;	//	Pointeur vair un tableau de l'epis qui contient l'etat du philos
	int				*ph_meal;	//	Pointeur vair un tableau de l'epis qui contient l'etat des repas
}				t_p_kinesis;
